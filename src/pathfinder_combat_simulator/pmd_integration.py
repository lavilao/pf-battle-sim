...
class MonsterListDownloader:
    ...
    def _save_monster_list(self):
        ...
        # Convert tuples to serializable format for JSON
        serializable_list = [{"name": name, "url": url} for name, url in self.monster_list]
...
class PMDIntegrator:
    ...
    def _setup_pmd_environment(self):
        ...
        try:
            ...
            class_hds_path = os.path.join(current_script_dir, "data_acquisition", "pmd", "data", "class_hds.json")
    ...
    def parse_monster_html(self, html: str, url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            from .data_acquisition.pmd.main import parsePage
